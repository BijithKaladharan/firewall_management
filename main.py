...
def main_menu():
    print("____Firewall Management____")
...
#print(sudo firewall-cmd --list-all --zone=home)  ->>to list the perticular zone details
#print(sudo firewall-cmd --list-all) -->>default public
